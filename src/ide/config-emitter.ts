...
/**
 * Generate eslint.config.mjs that re-exports from quick-lint.
 ...
 *
 * The proxy is intentionally short — `quick-lint` must be in node_modules
...
async function emitEslintConfig(cwd: string): Promise<void> {
    ...
    const content = [
        '// Auto-generated by quick-lint — DO NOT EDIT manually',
...
/**
 * Add a quick-lint section to .gitignore (if not already present).
 */
async function updateGitignore(cwd: string): Promise<void> {
    const gitignorePath = path.join(cwd, '.gitignore');
    const marker = '# quick-lint generated';
    ...
    logger.success('Updated .gitignore with quick-lint section');
}
